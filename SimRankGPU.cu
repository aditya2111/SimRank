...
void SimRankForAllNodes(int iteration, double* SimRank, int n_vertices, double confidence_value) {
   ...
   for(int i = 0; i < n_vertices; i++) {
       ...
       for(int j = 0; j < n_vertices; j++) {
           ...
           int ia_size, ib_size;
           int* I_A = findInNeighbors(i, edgesOffset,edgesSize, n_vertices, &ia_size);
           int* I_B = findInNeighbors(j, edgesOffset,edgesSize, n_vertices, &ib_size);
           /******************************/
